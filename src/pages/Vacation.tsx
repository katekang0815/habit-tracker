  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-yellow-50 relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 max-w-md mx-auto pt-8">
        ...
        <Card className="bg-card/95 backdrop-blur-sm border-border/50 shadow-lg mb-8 py-10 px-12 w-fit max-w-[90%]">
                    ...
                    <div className="flex flex-col items-center">
                      <Popover open={showStartCalendar} onOpenChange={setShowStartCalendar}>
                        <PopoverTrigger asChild>
                          <Button
                            variant="ghost"
                            className="text-lg font-medium text-foreground border-b-2 border-primary bg-transparent rounded-none hover:bg-transparent pl-4 pr-2 py-1"
                          >
                    ...
                    <div className="flex flex-col items-center">
                      <Popover open={showEndCalendar} onOpenChange={setShowEndCalendar}>
                        <PopoverTrigger asChild>
                          <Button
                            variant="ghost"
                            className="text-lg font-medium text-foreground border-b-2 border-primary bg-transparent rounded-none hover:bg-transparent pl-2 pr-4 py-1"
                          >
