        ...
        <div className="space-y-8 rounded-xl border border-gray-300 bg-background p-5">
          ...
          <div>
            ...
            <Input
              ...
              className="border border-gray-300 hover:border-2 hover:border-green-500"
            />
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              className="min-h-[100px] resize-none border border-gray-300 hover:border-2 hover:border-green-500"
