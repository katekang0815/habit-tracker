...
DROP POLICY IF EXISTS "Users can view own habit snapshots" ON public.habit_snapshots;
DROP POLICY IF EXISTS "Users can insert own habit snapshots" ON public.habit_snapshots;
DROP POLICY IF EXISTS "Users can update own habit snapshots" ON public.habit_snapshots;
DROP POLICY IF EXISTS "Users can delete own habit snapshots" ON public.habit_snapshots;
...
BEGIN
    ...
    LOOP
        ...
        AND hc.completion_date::DATE = target_date;
