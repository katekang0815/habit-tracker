...
DROP TRIGGER IF EXISTS validate_social_share_before_update ON public.social_shares;
DROP TRIGGER IF EXISTS deactivate_share_on_linkedin_removal_trigger ON public.profiles;

-- Clean up existing functions
DROP FUNCTION IF EXISTS public.validate_social_share_linkedin();
DROP FUNCTION IF EXISTS public.deactivate_share_on_linkedin_removal();
